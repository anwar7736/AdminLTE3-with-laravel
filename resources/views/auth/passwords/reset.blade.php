                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            <label for="reset-password-new">Email Address</label>
                                        </div>
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input class="form-control form-control-merge" id="reset-password-new" type="email" name="reset-password-new" placeholder="example@gmail.com" aria-describedby="reset-password-new" autofocus="" tabindex="1" />
